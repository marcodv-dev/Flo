...
const BTN_STYLE = { width:52, height:52, borderRadius:'50%', cursor:'pointer', fontWeight:700, fontSize:14, display:'flex', alignItems:'center', justifyContent:'center', color:'#1F2937' }
...
export default function Toolbar({ listActive, boldActive, saveDisabled, onList, onBold, onNewline, onTimestamp, onFinish }) {
  ...
  return (
    <div className="toolbar" style={{ position:'fixed', bottom:kb, left:0, right:0, display:'flex', justifyContent:'center', gap:14, padding:'12px 20px calc(12px + env(safe-area-inset-bottom, 0px))', background:'transparent' }}>
