...
export default function Toolbar({ listActive, boldActive, saveDisabled, onList, onBold, onNewline, onTimestamp, onFinish }) {
  return (
    <div className="toolbar" style={{ display:'flex', justifyContent:'center', gap:14, padding:'12px 20px calc(12px + env(safe-area-inset-bottom, 0px))', background:'transparent' }}>
