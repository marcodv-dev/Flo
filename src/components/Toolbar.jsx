...
export default function Toolbar({ listActive, boldActive, saveDisabled, onList, onBold, onNewline, onTimestamp, onFinish }) {
  return (
    <div className="toolbar" style={{ position:'fixed', bottom:0, left:0, right:0, display:'flex', justifyContent:'center', gap:14, padding:'12px 20px 28px', background:'transparent' }}>
